...
import { Container, Row, Col, Image, Stack, Form, Dropdown, Button } from 'react-bootstrap'
        ...
        <Container>
            <Row>
                <Col md={12}>
                    ...
                    <p className='post-title'> File types supported: JPG, PNG, GIF, SVG, MP4, WEBM, MP3, WAV, OGG, GLB, GLTF. Max size: 100 MB</p>
                    ...
                    <Stack>
                        ...
                        <Form className='post-textarea' as="textarea" placeholder='Please discribe detail discription of your Item' rows={3} />
                    </Stack>
                    <Stack>
                    ...
                    <Stack>
                        ...
                        <Dropdown>
                            <Dropdown.Toggle className="post-dropdown" style={{ display: "flex", backgroundColor: "#2E2C38", border: "none" }}>
